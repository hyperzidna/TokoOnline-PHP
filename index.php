...
<body>
    ...
    <div class="container-fluid warna3 py-5">
        <div class="container text-center">
            <h3>Tentang Kami</h3>
            <p class="fs-5 mt-3">
            BukaStore merupakan situs belanja online terpercaya di Indonesia yang menjual
             beragam Fashion yang dibutuhkan seluruh masyarakat Indonesia. Sarana jual beli online BukaStore memiliki visi untuk menjadi marketplace 
             nomor satu di Indonesia dengan misi untuk memberdayakan UKM di seluruh penjuru Indonesia.            </p>
        </div>
    </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-text text-harga">Rp <?php echo $data['harga']; ?></div>
