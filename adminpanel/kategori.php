...
<body>
    ...
    <div class="container mt-5">
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="kategori.php" class= "no-decoration text-muted"><i class=""></i> Kategori</a></li>
            </ol>
        </nav>
        ...
        <div class="my-5 col-12 col-md-6">
            ...
            <form action="" method= "POST">
                <div>
                    ...
                    <input type="text" name="kategori" id="kategori" placeholder="Nama Kategori" class="form-control mt-2 ">
                </div>
                <div class="mt-3">
